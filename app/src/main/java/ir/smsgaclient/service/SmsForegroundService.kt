...
/**
 * Foreground service keeping the SMS monitoring bridge alive in background.
 * Uses LOW importance notification channel so it does not disturb the merchant.
 */
class SmsForegroundService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        Timber.i("SmsForegroundService started")
        return START_STICKY
    }
