...
/**
 * High-priority BroadcastReceiver (priority 999) intercepting bank SMS.
 * Persists raw SMS directly to Room DB before any network or processing.
 * Guarantee: Zero SMS loss.
 */
class SmsReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                // 1. Persist raw SMS to Room DB first (Rule 6: Never lose an SMS)
